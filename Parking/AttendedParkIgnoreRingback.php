...
$this->markTestIncomplete('Unknown issue');
        ...
        $channel_b_3->waitHangup(30);

        $channel_b_4 = self::ensureChannel( self::$b_device->waitForInbound(self::$b_device->getSipUsername(), 30) );
        $channel_b_4->answer();
        $channel_b_4->waitAnswer();

        self::ensureTalking($channel_a, $channel_b_4);
        self::hangupBridged($channel_a, $channel_b_4);
    }
}
